  ...
  class d {
        ...
        .then((a) =>
          a
            ...
            .map((a, b) => ({
              id: a.deviceId,
              label:
                a.label || (0 === b ? "Default Camera" : `Camera ${b + 1}`),
            }))
        )
        .finally(() => {
    ...
    constructor(
      ...
      requestAnimationFrame(() => {
        ...
        "none" === b.display &&
          (a.style.setProperty("display", "block", "important"), (g = !0));
        "visible" !== b.visibility &&
          (a.style.setProperty("visibility", "visible", "important"), (g = !0));
        g &&
          (console.warn(
    ...
    static scanImage(a, b = null, c = null, f = null, k = !1, g = !1) {
      let h = c instanceof Worker,
        l = Promise.all([c || d.createQrEngine(), d._loadImage(a)]).then(
          ([a, g]) => {
            c = a;
            let l;
