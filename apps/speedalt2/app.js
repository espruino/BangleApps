...
function nextFunc(dur) {
  if (cfg.modeA == 0 || cfg.modeA == 1) {
    ...
    if (dur < 2) showMax = !showMax;
    // Short press toggle fix/max display
    else {
      maxSpd = 0;
      maxAlt = 0;
...
if (cfg.colour == 3)
  img.palette = new Uint16Array([0xffff, 0x007f, 0x0054, 0x0054]);
