...
function UBX_CFG_PM2(update, search) {
  ...
  writeGPScmd([
    ...
    0x00,
    0x00,
    0x00 /* v1, reserved 1..3 */,
    0x00,
    0x10,
    0x00,
    0x00 /* on/off-mode, update ephemeris */,
    u[3],
    u[2],
    u[1],
    u[0] /* update period, ms, 120s=00 01 D4 C0, 30s= 00 00 75 30 */,
    s[3],
    s[2],
    s[1],
    s[0] /* search period, ms, 120s, 20s = 00 00 4E 20, 5s = 13 88 */,
    0x00,
    0x00,
    0x00,
    0x00 /* grid offset */,
    0x00,
    0x00 /* on-time after first fix */,
    0x01,
    0x00 /* minimum acquisition time */,
    0x00,
    0x00,
    0x00,
    0x00 /* reserved 4,5 */,
...
function UBX_CFG_RXM() {
  ...
  writeGPScmd([
    0x06, 0x11 /* UBX-CFG-RXM */, 2, 0 /* length */, 0x08, 0x01,
