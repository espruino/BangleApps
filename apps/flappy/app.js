...
var BIRDIMG = E.toArrayBuffer(
  atob(
    ""
  )
);
var FLOORIMG = require("heatshrink").decompress(
  atob("iEKxH+kklABuLAAlgAAwNFB34OLmAAO0YAO5wAOA")
);
...
function gameStart() {
  ...
  birdvy = 0;
  barriers = [];
  for (var i = 38; i < g.getWidth(); i += 38) newBarrier(i);
  score = 0;
}
...
function draw() {
  ...
  barriers.forEach(function (r) {
    ...
    if (r.x1 < 6 && (birdy - 3 < btop || birdy + 3 > bbot)) gameStop();
  });
