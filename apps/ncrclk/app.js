...
function drawHands(full) {
  ...
  var rhr =
    ((d.getHours() + Math.round(d.getMinutes() / 10) / 6) * Math.PI) / 6;
  var bounds = {};
  if (!full) {
    // work out the bounds of the hands
