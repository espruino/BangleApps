...
var compiled = (function () {
  var bin = atob(
    "Len3TwAnT/BPCPsAAJMI+wfzAOsDCdMYAZMAJhn4BkAAnQTwDwMD68YDBesUFAg7CDzdEE/q5AoI+wpaQfJvNapFItgB6woOA/AHAxH4CsCe+AGww/EIBQX7DPwD+wvMnvhPsATwBwQF+wv1ZUPE8QgKCvsMXJ74UFBrQwT7A8SkEQQ8JOrkdADgACQBm5xVATZPLsLRATdAL7bRA7C96PCPAAA="
  );
  return {
...
Graphics.prototype.setFont5x9Numeric7Seg = function () {
  this.setFontCustom(
    atob(
      "AAAAAAAAAAIAAAQCAQAAAd0BgMBdwAAAAAAAdwAB0RiMRcAAAERiMRdwAcAQCAQdwAcERiMRBwAd0RiMRBwAAEAgEAdwAd0RiMRdwAcERiMRdwAFAAd0QiEQdwAdwRCIRBwAd0BgMBAAABwRCIRdwAd0RiMRAAAd0QiEQAAAAAAAAAA="
    ),
    32,
    atob("BgAAAAAAAAAAAAAAAAYCAAYGBgYGBgYGBgYCAAAAAAAABgYGBgYG"),
    9
  );
};
...
(function () {
  ...
  for (var n = 0; n < PALETTES; n++)
    if (!files.includes("geissclk." + n + ".pal")) allOk = false;
  for (var n = 0; n < MAPS; n++)
    if (!files.includes("geissclk." + n + ".map")) allOk = false;
  if (!allOk) eval(require("Storage").read("geissclk.precompute.js"));
})();
