...
function setBigFont() {
  g.setFontCustom(bigCustomFont[0], 48, bigCustomFont[1], 58);
}

function setSmallFont() {
  g.setFontCustom(smallCustomFont[0], 32, smallCustomFont[1], 12);
}
...
function drawSegment(align, base, str) {
  ...
  if (align === "c") {
    point = base + maxSegmentWidth / 2 - g.stringWidth(str) / 2;
  }
...
function drawDate(str) {
  ...
  g.setColor("#777");
  g.drawString(str, maxSegmentWidth - g.stringWidth(str), middleY - 22, false);
}
