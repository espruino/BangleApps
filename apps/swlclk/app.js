...
function drawTime() {
  ...
  var beats = Math.floor(
    ((((utc[0] + 1) % 24) + utc[1] / 60 + utc[2] / 3600) * 1000) / 24
  );
  ...
  switch (utc[0]) {
    ...
    case 2:
      g.clearRect(0, 25, 240, 80);
      g.drawString(
        "02h30-03h00 R. Argentine vers le monde\n5800",
        xyCenter,
        30
      );
      break;
    ...
    case 9:
      g.clearRect(0, 25, 240, 80);
      g.drawString(
        "09h00-10h00 R. Argentine vers le monde\n5950\n09h00-10h00 R.F.I.\n13695 15300 15320",
        xyCenter,
        30
      );
      break;
    ...
    case 13:
      g.clearRect(0, 25, 240, 80);
      g.drawString(
        "13h00-14h00 Radio for Peace Int.\n15770\n13h30-14h00 Radio Slovaquie Int.\n6005",
        xyCenter,
        30
      );
      break;
