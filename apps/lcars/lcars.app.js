...
var iconMoon = {
  ...
  buffer: require("heatshrink").decompress(
    atob(
      ""
    )
  ),
};
...
var iconNoBattery = {
  ...
  buffer: require("heatshrink").decompress(
    atob(
      ""
    )
  ),
};
