...
function drawN(){
  ...
  if (dist<30.48)
    buf.drawString((dist*3.281).toFixed(0)+" ft",60,30);
  else
    buf.drawString((dist/1852).toFixed(2)+" NM",60,30);
  flip(buf,Yoff+130);
  g.setFont("6x8",1);
  g.setColor(0,0,0);
