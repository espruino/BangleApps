...
function flip2(x, y) {
  g.drawImage(
    { width: 80, height: 40, bpp: 1, buffer: buf2.buffer, palette: pal2color },
    x,
    y
  );
  buf2.clear();
...
function drawCompass(hd) {
  ...
  hd = (hd * Math.PI) / 180;
  var p = [0, 1.1071, Math.PI / 4, 2.8198, 3.4633, (7 * Math.PI) / 4, 5.176];

  // using polar cordinates, 64,64 is the offset from the 0,0 origin
  var poly = [
    64 + 60 * Math.sin(hd + p[0]),
    64 - 60 * Math.cos(hd + p[0]),
    64 + 44.7214 * Math.sin(hd + p[1]),
    64 - 44.7214 * Math.cos(hd + p[1]),
    64 + 28.2843 * Math.sin(hd + p[2]),
    64 - 28.2843 * Math.cos(hd + p[2]),
    64 + 63.2455 * Math.sin(hd + p[3]),
    64 - 63.2455 * Math.cos(hd + p[3]),
    64 + 63.2455 * Math.sin(hd + p[4]),
    64 - 63.2455 * Math.cos(hd + p[4]),
    64 + 28.2843 * Math.sin(hd + p[5]),
    64 - 28.2843 * Math.cos(hd + p[5]),
    64 + 44.7214 * Math.sin(hd + p[6]),
    64 - 44.7214 * Math.cos(hd + p[6]),
  ];
...
function docalibrate(e, first) {
  ...
  if (first) E.showAlert(msg, title).then(action.bind(null, true));
  else
    E.showPrompt(msg, {
      title: title,
