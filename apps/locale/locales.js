...
var locales = {
  ...
  cs_CZ: {
    // THIS NEVER WORKED PROPERLY - many chars are not in the ISO8859-1 codepage and we use charFallbacks
    lang: "cs_CZ",
    decimal_point: ",",
    thousands_sep: " ",
    currency_symbol: "Kč",
  ...
  lv_LV: {
    ...
    month:
      "Janvāris,Februāris,Marts,Aprīlis,Maijs,Jūnijs,Jūlijs,Augusts,Septemberis,Oktobris,Novembris,Decembris",
