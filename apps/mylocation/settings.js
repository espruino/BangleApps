...
const locations = ["Raleigh", "Detroit", "New York" ,"Los Angeles", "London" ,"Newcastle","Edinburgh", "Paris" ,  "Tokyo"  , "Frankfurt", "Auckland", "???"];
const lats =      [ 35.7796 , 42.3314  ,  40.7128   , 34.0522     , 51.5072  ,  54.9783  , 55.9533   , 48.8566 ,  35.6762 ,  50.1236   ,  -36.9    ,  0.0  ];
const lons =      [ -78.6382, -83.0458 , -74.0060   , -118.2437   , -0.1276  ,  -1.6178  , -3.1883   ,  2.3522 ,  139.6503 ,   8.6553   ,  174.7832 ,  0.0 ];
