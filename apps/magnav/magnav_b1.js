const Yoff = 80;
var pal2color = new Uint16Array(
  [g.theme.bg, g.theme.fg, g.theme.fg2, 0xc618],
  0,
  2
);
...
function flip(b, y) {
  g.drawImage(
    { width: 240, height: 60, bpp: 2, buffer: b.buffer, palette: pal2color },
    0,
    y
  );
  b.clear();
