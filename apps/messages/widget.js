WIDGETS["messages"] = {
  ...
  draw: function () {
    ...
    g.drawImage(
      c & 1
        ? atob(
            "GBiBAAAAAAAAAAAAAAAAAAAAAB//+DAADDAADDAADDwAPD8A/DOBzDDn/DA//DAHvDAPvjAPvjAPvjAPvh///gf/vAAD+AAB8AAAAA=="
          )
        : atob(
            "GBiBAAAAAAAAAAAAAAAAAAAAAB//+D///D///A//8CP/xDj/HD48DD+B8D/D+D/3vD/vvj/vvj/vvj/vvh/v/gfnvAAD+AAB8AAAAA=="
          ),
      this.x,
      this.y
    );
