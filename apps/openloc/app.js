  ...
  var t = "23456789CFGHJMPQRVWX",
    ...
    o =
      ...
      (e.isValid = function (e) {
        ...
        if (e.indexOf("0") > -1) {
          ...
          if (r.length > 1 || r[0].length % 2 == 1 || r[0].length > 6)
            return !1;
    ...
    a = (e.isFull = function (e) {
      return (
        !!o(e) &&
        !i(e) &&
        !(t.indexOf(e.charAt(0).toUpperCase()) * r >= 180) &&
        !(e.length > 1 && t.indexOf(e.charAt(1).toUpperCase()) * r >= 360)
      );
    }),
    u = (e.encode = function (t, r, n) {
      if (
        ((t = Number(t)),
        (r = Number(r)),
        (n = void 0 === n ? e.CODE_PRECISION_NORMAL : Number(n)),
        isNaN(t) || isNaN(r) || isNaN(n))
      )
    ...
    f = (e.decode = function (e) {
      ...
      return x(
        t.latitudeLo + r.latitudeLo,
        t.longitudeLo + r.longitudeLo,
        t.latitudeLo + r.latitudeHi,
        t.longitudeLo + r.longitudeHi,
        t.codeLength + r.codeLength
      );
    }),
    l =
      ((e.recoverNearest = function (e, t, r) {
        if (!i(e)) {
          if (a(e)) return e;
          throw "ValueError: Passed short code is not valid: " + e;
        }
        if (((t = Number(t)), (r = Number(r)), isNaN(t) || isNaN(r)))
        ...
        return (
          t + d < s.latitudeCenter && s.latitudeCenter - o >= -90
            ? (s.latitudeCenter -= o)
            : t - d > s.latitudeCenter &&
              s.latitudeCenter + o <= 90 &&
              (s.latitudeCenter += o),
          r + d < s.longitudeCenter
            ? (s.longitudeCenter -= o)
            : r - d > s.longitudeCenter && (s.longitudeCenter += o),
          u(s.latitudeCenter, s.longitudeCenter, s.codeLength)
        );
      }),
      (e.shorten = function (e, t, r) {
        if (!a(e)) throw "ValueError: Passed code is not valid and full: " + e;
        if (-1 != e.indexOf("0"))
          throw "ValueError: Cannot shorten padded codes: " + e;
        var e = e.toUpperCase(),
          o = f(e);
        if (o.codeLength < 6)
          throw "ValueError: Code length must be at least 6";
        if (((t = Number(t)), (r = Number(r)), isNaN(t) || isNaN(r)))
          throw "ValueError: Reference position are not numbers";
        (t = l(t)), (r = h(r));
        for (
          var i = Math.max(
              Math.abs(o.latitudeCenter - t),
              Math.abs(o.longitudeCenter - r)
            ),
            u = n.length - 2;
          u >= 1;
          u--
        )
          if (i < 0.3 * n[u]) return e.substring(2 * (u + 1));
        return e;
      }),
      function (e) {
    ...
    d = function (e) {
      return e <= 10
        ? Math.pow(20, Math.floor(e / -2 + 2))
        : Math.pow(20, -3) / Math.pow(5, e - 10);
    },
    h = function (e) {
      for (; e < -180; ) e += 360;
      for (; e >= 180; ) e -= 360;
    ...
    s = function (e, r, o) {
      for (var i = "", a = e + 90, u = r + 180, f = 0; f < o; ) {
        ...
        (a -= d * l),
          (i += t.charAt(d)),
          (f += 1),
          (u -= (d = Math.floor(u / l)) * l),
          (i += t.charAt(d)),
          8 == (f += 1) && f < o && (i += "+");
      }
      return (
        i.length < 8 && (i += Array(8 - i.length + 1).join("0")),
        8 == i.length && (i += "+"),
        i
      );
    },
    ...
    p = function (e, r) {
      for (var o = 0, i = 0; 2 * o + r < e.length; )
        (i += t.indexOf(e.charAt(2 * o + r)) * n[o]), (o += 1);
      return [i, i + n[o - 1]];
    },
    C = function (e) {
      for (var r = 0, n = 0, o = 125e-6, i = 125e-6, a = 0; a < e.length; ) {
        var u = t.indexOf(e.charAt(a));
        (r += Math.floor(u / 4) * (o /= 5)),
          (n += (u % 4) * (i /= 4)),
          (a += 1);
      }
    ...
    (x.fn = x.prototype =
      {
        init: function (e, t, r, n, o) {
          (this.latitudeLo = e),
            ...
            (this.longitudeHi = n),
            (this.codeLength = o),
            (this.latitudeCenter = Math.min(e + (r - e) / 2, 90)),
            (this.longitudeCenter = Math.min(t + (n - t) / 2, 180));
        },
      }),
