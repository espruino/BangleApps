(() => {
  function getFace() {
    ...
    function freeResources() {
      ...
      CALIBDATA = undefined;
      wp = undefined;
      if (Bangle.isCompassOn !== undefined && Bangle.isCompassOn())
    ...
    function getWaypoint() {
      ...
      if (gpsObject.getState() === gpsObject.GPS_RUNNING) bearing = wp_bearing;
      else bearing = 0;
    ...
    function drawCompass(angle, col) {
      ...
      var poly = [
        120 + 60 * Math.sin(angle + p[0]),
        120 - 60 * Math.cos(angle + p[0]),
        120 + 44.7214 * Math.sin(angle + p[1]),
        120 - 44.7214 * Math.cos(angle + p[1]),
        120 + 28.2843 * Math.sin(angle + p[2]),
        120 - 28.2843 * Math.cos(angle + p[2]),
        120 + 63.2455 * Math.sin(angle + p[3]),
        120 - 63.2455 * Math.cos(angle + p[3]),
        120 + 63.2455 * Math.sin(angle + p[4]),
        120 - 63.2455 * Math.cos(angle + p[4]),
        120 + 28.2843 * Math.sin(angle + p[5]),
        120 - 28.2843 * Math.cos(angle + p[5]),
        120 + 44.7214 * Math.sin(angle + p[6]),
        120 - 44.7214 * Math.cos(angle + p[6]),
      ];
    ...
    function tiltfixread(O, S) {
      ...
      var xh =
        m.dy * costheta + m.dx * sinphi * sintheta + m.dz * cosphi * sintheta;
    ...
    function drawGPSData() {
      ...
      if (previous.dst !== dst) {
        ...
        if (gpsObject.waypointHasLocation()) g.setColor(0x07ff);
