...
const showMainMenu = () => {
  ...
  const showMenu = (menu, scroll, cur) => () => {
    E.showMenu(menu);
...
const barMenu = {
  ...
  "Active": {
    ...
    onchange: v => { updateSetting('barEnabled', v); }
  },
  "Altitude": { value: null },
  "Press": { value: null },
  "Temp": { value: null },
...
const gpsMenu = {
  ...
  "Active": {
    ...
    onchange: v => { updateSetting('gpsEnabled', v); }
  },
  "Lat": { value: null },
  "Lon": { value: null },
  "Altitude": { value: null },
...
const hrmMenu = {
  ...
  "Active": {
    ...
    onchange: v => { updateSetting('hrmEnabled', v); }
  },
  "BPM": { value: null },
...
const magMenu = {
  ...
  "Active": {
    ...
    onchange: v => { updateSetting('magEnabled', v); }
  },
  "x": { value: null },
  "y": { value: null },
  "z": { value: null },
