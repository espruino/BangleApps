...
var img = {
  ...
  buffer: require("heatshrink").decompress(
    atob(
      ""
    )
  ),
};
...
function drawPlayers() {
  ...
  var offset = 0;
  if (max > 200) offset = max - 200;

  var d = 63 - (offset & 63);
  g.fillRect(0, 10, 240, 12);
  for (var x = d; x < 240; x += 64) g.fillRect(x, 12, x + 2, 12 + 20);
  var y = 20;
  ...
  for (var x = d; x < 240; x += 64) g.fillRect(x, 152, x + 2, 160);
  g.flip();
}
