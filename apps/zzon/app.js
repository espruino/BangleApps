...
async function runMap() {
    ...
    <html>
    <head>
        <title>OpenStreetMap Circle and Geofencing Example</title>
        <style>
            /* Set the size of the map */
            #map {
                height: 400px;
    ...
    <body>
        <h1>OpenStreetMap Circle and Geofencing Example</h1>
        <div id="map"></div>

        <script>
            // Initialize the map
            var map = L.map('map').setView([21.331115, 39.946196], 12);
            ...
            // Create a circle overlay on the map
            var circle = L.circle([21.331115, 39.946196], {
                color: 'red',
                fillColor: '#f03',
                fillOpacity: 0.35,
                radius: 5000 // 5000 meters radius (5km)
            ...
            function onLocationError(e) {
                console.error("Error getting user's position:", e.message);
            }
