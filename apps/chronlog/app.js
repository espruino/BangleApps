...

{
  ...
  */
  ...
  let syncToAndroid = (taskName, isFullSync)=>{
    ...
    let storageFile = require("Storage").open("chronlog_"+taskName+".csv", "r");
    ...
    let doSyncLine = (mde)=>{Bluetooth.println(JSON.stringify({t:"file", n:"chronlog_"+taskName+".csv", c:contents, m:mde}));};
