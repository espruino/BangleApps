...
* **Haptics** On devices with 2v29.14+ firmware version, this allows you to enable/disable system haptics in menus, prompts, back, etc. It also allows you to customize the strength of the haptic.
