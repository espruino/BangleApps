...
function showWhitelistMenu() {
  ...
  if (settings.whitelist)
    settings.whitelist.forEach(function (d) {
...
function makeConnectable() {
  ...
  E.showPrompt(name + "\nStay Connectable?", { title: "Connectable" }).then(
    (r) => {
      if (settings.ble != r) {
        settings.ble = r;
        updateSettings();
