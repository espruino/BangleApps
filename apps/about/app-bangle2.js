...
var logo = E.toArrayBuffer(
  atob(
    ""
  )
);
...
function drawInfo() {
  ...
  g.setFont("4x6")
    .setFontAlign(0, 0)
    .drawString("BANGLEJS.COM", W - 30, 56);
  var h = 8,
    y = 24 - h;
  ...
  g.drawString(
    "Storage: " + (require("Storage").getFree() >> 10) + "k free",
    0,
    (y += h)
  );
  if (ENV.STORAGE)
    g.drawString("         " + (ENV.STORAGE >> 10) + "k total", 0, (y += h));
  if (ENV.SPIFLASH)
    g.drawString("SPI Flash: " + (ENV.SPIFLASH >> 10) + "k", 0, (y += h));
  imageTop = y + h;
