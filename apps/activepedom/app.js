(() => {
  ...
  Modules.addCached("graph", function () {
    exports.drawAxes = function (b, c, a) {
      ...
      var k = a.padx || 0,
        ...
        n =
          (void 0 !== a.miny
            ? a.miny
            : (a.miny = c.reduce(function (a, b) {
                return Math.min(a, b);
              }, c[0]))) - d;
      c =
        (void 0 !== a.maxy
          ? a.maxy
          : (a.maxy = c.reduce(function (a, b) {
              return Math.max(a, b);
            }, c[0]))) + d;
      a.gridy &&
        ((d = a.gridy),
      ...
      a.axes &&
        (null !== a.ylabel && ((e += 6), (m -= 6)),
        null !== a.xlabel && (g -= 6));
      a.title && ((f += 6), (g -= 6));
      a.axes &&
        (b.drawLine(e, f, e, f + g), b.drawLine(e, f + g, e + m, f + g));
      a.title &&
        (b.setFontAlign(0, -1), b.drawString(a.title, e + m / 2, f - 6));
      var x = w - t,
        u = c - n;
      u || (u = 1);
      if (a.gridx) {
        ...
        for (d = Math.ceil((t + k) / v) * v; d <= w - k; d += v) {
          ...
          null !== a.xlabel &&
            r > q &&
            b.getWidth() > r + q &&
            b.drawString(p, r, f + g + 2);
        }
      }
      if (a.gridy)
        for (b.setFontAlign(0, 0, 1), d = n; d <= c; d += a.gridy)
          (k = l(d)),
            (p = a.ylabel ? a.ylabel(d) : d),
            b.setPixel(e + 1, k),
            (q = b.stringWidth(p) / 2),
            null !== a.ylabel &&
              k > q &&
              b.getHeight() > k + q &&
              b.drawString(p, e - 5, k + 1);
      b.setFontAlign(-1, -1, 0);
      return { x: e, y: f, w: m, h: g, getx: h, gety: l };
    };
    exports.drawLine = function (b, c, a) {
      ...
      for (l in c)
        h
          ? b.moveTo(a.getx(l), a.gety(c[l]))
          : b.lineTo(a.getx(l), a.gety(c[l])),
          (h = !1);
      return a;
    };
  ...
  function getArrayFromCSV(file, column) {
    ...
    while ((nextLine = file.readLine())) {
      ...
      if (nextLine) {
        ...
        if (diff <= history) {
          //only entries from the last x ms
  ...
  function drawGraph() {
    ...
    filename = filename =
      "activepedom" + now.getFullYear() + month + now.getDate() + ".data";
    ...
    last =
      getDate(times[times.length - 1]) + " " + getTime(times[times.length - 1]); //last entry in datafile
    //free memory
    csvFile = undefined;
    times = undefined;
  ...
  function getImage() {
    return require("heatshrink").decompress(
      atob(
        "mEwwIGDvAEDgP+ApMD/4FVEZY1FABcP8AFDn/wAod/AocB//4AoUHAokPAokf5/8AocfAoc+j5HDvgFEvEf7+AAoP4AoJCC+E/54qCsE/wYkDn+AAos8AohZDj/AAohrEp4FEs5xEuJfDgF5Aon4GgYFBGgZOBnyJD+EeYgfgj4FEh6VD4AFDh+AAIJMCBoIFFLQQtBgYFCHIIFDjA3BC4I="
      )
    );
  }
