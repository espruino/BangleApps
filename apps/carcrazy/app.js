...
function collision() {
  if (gameStatus == GAMEPLAYING) {
    ...
    if (
      ...
      enemyCarFrontY2 < 300 &&
      enemyCarFrontY2 > playerCarFrontY &&
...
function moveEnemyCar() {
  if (gameStatus == GAMEPLAYING) {
    ...
    if (
      enemyPositonCenterY > 200 &&
      (enemyPositonCenterY2 > 200 || level < 4)
    ) {
