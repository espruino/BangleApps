...
* **Barometer:** Shows the current air pressure on a 180-degree 950-1050 hPa dial (like the battery gauge) using the built-in pressure sensor. The sensor only runs while this screen is shown.
